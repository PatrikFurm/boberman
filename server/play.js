...
var Play = {
    ...
    updatePlayerPosition: function (coordinates) {
        ...
        //serverSocket.sockets.in(this.socket_game_id).emit('move player', data);
    ...
    onPlayerDied: function(coordinates) {
        ...
        setTimeout(function() {
            serverSocket.sockets.to(game_id).emit('player win', alivePlayerName);
        }, 3000);
    },
